...
@section('content')
    <div class="container-fluid py-3">
        <div class="mb-4">
            <h1 class="h4 fw-bold text-dark mb-1">Edit Laporan</h1>
            <p class="text-muted small mb-0">Perbarui informasi laporan: <strong>{{ $report->title }}</strong></p>
        </div>
        ...
        <div class="alert alert-info mb-4">
            <div class="row g-2 small">
                <div class="col-6">
                    ...
                    <span
                        class="badge bg-{{ $report->status === 'completed' ? 'success' : ($report->status === 'processing' ? 'warning' : 'secondary') }}">{{ ucfirst($report->status) }}</span>
                </div>
                ...
                <form action="{{ route('admin.reports.update', $report) }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" id="filter_min_amount" name="filters[min_amount]" step="1000"
                                        value="{{ $report->filters['min_amount'] ?? '' }}" placeholder="0"
                    ...
                    <div class="border-top pt-4 d-flex flex-column flex-md-row gap-2 justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm order-1 order-md-2">
                            ...
                            <span class="d-none d-sm-inline">Simpan Perubahan</span><span class="d-sm-none">Simpan</span>
                        </button>
                    </div>
                </form>
            </div>
