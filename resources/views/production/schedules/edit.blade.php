        ...
        <div class="card-body text-white py-4 position-relative" style="z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-7 mb-3 mb-md-0">
                    <h2 class="fw-bold mb-2 text-shadow">Edit Jadwal Produksi</h2>
                    <p class="text-white text-opacity-90 mb-0"><i class="bi bi-pencil-square me-1"></i>Perbarui informasi jadwal</p>
                </div>
