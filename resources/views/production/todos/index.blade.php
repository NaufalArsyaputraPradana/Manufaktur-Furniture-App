        ...
        <div class="card-body text-white py-4 position-relative" style="z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-7 mb-3 mb-md-0">
                    <h2 class="fw-bold mb-2 text-shadow">To Do List Produksi</h2>
                    <p class="text-white text-opacity-90 mb-0"><i class="bi bi-clipboard-check me-1"></i>Kelola tugas harian sebagai staf produksi</p>
                </div>
                <div class="col-lg-4 col-md-5 text-lg-end">
                    <a href="{{ route('staff.production.todos.create') }}" class="btn btn-light shadow-sm text-primary fw-bold">
