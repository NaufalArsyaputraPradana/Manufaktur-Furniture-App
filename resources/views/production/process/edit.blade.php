...
<div class="container-fluid px-3 px-md-4">
        ...
        <div class="card-body text-white py-4 position-relative" style="z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-7 mb-3 mb-md-0">
                    <h2 class="fw-bold mb-2 text-shadow">Edit Proses Produksi</h2>
                    <p class="text-white text-opacity-90 mb-0"><i class="bi bi-pencil-square me-1"></i>Perbarui data proses produksi</p>
                </div>
                <div class="col-lg-4 col-md-5 text-lg-end">
                    <a href="{{ route('production.tracking.show', $process) }}" class="btn btn-light shadow-sm text-primary fw-bold">
    ...
    {{-- Order Info Banner --}}
    <div
    class="alert alert-info bg-opacity-10 border-info d-flex align-items-center gap-3 mb-5 rounded-4 shadow-sm">
