...
<style>
    ...
    .progress-card { padding: 2rem; border-radius: 1rem; background: white; border: 1px solid #f0f0f0; }
    .progress-value { font-size: 3rem; font-weight: 700; background: linear-gradient(135deg, var(--prod-primary) 0%, var(--prod-secondary) 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
    .stat-row { padding: 1rem 0; border-bottom: 1px solid #f0f0f0; display: flex; justify-content: space-between; align-items: center; }
        ...
        <div class="card-body text-white py-4 position-relative" style="z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-7 mb-3 mb-md-0">
                    <h2 class="fw-bold mb-2 text-shadow">Detail Proses Produksi</h2>
                    <p class="text-white text-opacity-90 mb-0">
                        <i class="bi bi-hammer me-1"></i>Kode: {{ $process->production_code }} ·
                        <span class="badge bg-light text-dark ms-2">{{ $process->status_label }}</span>
                    </p>
                </div>
