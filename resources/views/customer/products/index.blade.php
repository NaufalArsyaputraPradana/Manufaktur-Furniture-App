                                ...
                                <div class="col-md-6 col-lg-4" role="listitem">
                                    <article class="product-card card h-100 border-0 shadow-sm rounded-4">
                                        ...
                                        <div class="product-image-wrapper position-relative overflow-hidden bg-light">
                                            ...
                                            @if ($productImage)
                                                <img src="{{ $productImage }}" class="card-img-top product-image w-100"
                                                ...
                                                <div class="card-img-top d-none align-items-center justify-content-center text-white"
                                                    ...
                                                    <div class="text-center">
                                                        <i class="bi bi-image display-3 mb-2 opacity-50"
                                                            aria-hidden="true"></i>
                                                        <p class="small mb-0 opacity-75 px-3">
                                            ...
                                            {{-- Status Badge --}}
                                            <span
                                                class="badge position-absolute top-0 end-0 m-3 shadow-sm {{ $product->is_active ? 'bg-success' : 'bg-secondary' }}">
                                        ...
                                        <div class="card-body d-flex flex-column p-4">
                                            <h3 class="h5 card-title mb-2 fw-bold text-dark">{{ $product->name }}</h3>
                                            ...
                                            @if ($product->dimensions)
                                                <div
                                                    class="d-flex align-items-center mb-3 text-muted small bg-light p-2 rounded-3 border">
                                                    <i class="bi bi-rulers me-2 text-primary flex-shrink-0"
                                                        aria-hidden="true"></i>
                                            ...
                                            <div class="mt-auto border-top pt-3">
                                                ...
                                                <div class="d-grid gap-2">
                                                            ...
                                                            <form action="{{ route('customer.cart.add') }}" method="POST"
                                                                ...
                                                                <button type="submit"
                                                                    ...
                                                                    <i class="bi bi-cart-plus-fill me-2"
                                                                        aria-hidden="true"></i> Tambah ke Keranjang
                                                                </button>
                                                            </form>
                                                        @endif
                                                    @endauth
                                                    ...
                                                    <a href="{{ route('products.show', $product->slug ?? $product->id) }}"
                                                        ...
                                                        <i class="bi bi-eye-fill me-2" aria-hidden="true"></i> Lihat
                                                        Detail
                                                    </a>
                                                </div>
                                            </div>
